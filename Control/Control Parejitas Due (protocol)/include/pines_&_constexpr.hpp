...
constexpr float tactico_reductora = 26*26*39; 
constexpr float tactico_diametro = 52.3;  //72.5; //67; 
...
constexpr float tactico_L = 248; 
constexpr float tactico_acel = 1500;
constexpr float tactico_decel = 1500;
