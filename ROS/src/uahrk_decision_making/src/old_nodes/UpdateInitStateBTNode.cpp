#include "uahrk_decision_making/UpdateInitStateBTNode.hpp"



UpdateInitiStateBTNode::UpdateInitiStateBTNode(
...
BT::NodeStatus UpdateInitiStateBTNode::tick(){
    // Servers not ready
    ...
    std::cout << "Setting output tree with " << tree << std::endl;
    // Update Grid Map
...
void UpdateInitiStateBTNode::halt(){
    return;
}
...
{
    factory.registerNodeType<UpdateInitiStateBTNode>("Update_init_state");
}
