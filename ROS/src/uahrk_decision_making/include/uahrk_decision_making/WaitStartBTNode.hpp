...
std::unordered_map<std::string,Pose2d> blue_spawns = {
    ...
    {"2", {2 - 0.225      , 1.5 + 0.150 + 0.225,  270.0}},
    {"3", {0.225          , 1.5 - 0.150 - 0.225,   90.0}},
    {"4", {0.725          , 0.225              ,    0.0}},
    {"5", {2 - 0.225      , 0.225              ,   90.0}}
};

std::unordered_map<std::string,Pose2d> green_spawns = {
    {"1", {2 - 0.225      , 3.0 - 0.225        ,  180.0}},
    {"2", {0.225          , 1.5 + 0.150 + 0.225,  270.0}},
    {"3", {2 - 0.225      , 1.5 - 0.150 - 0.225,   90.0}},
    {"4", {0.225          , 0.225              ,   90.0}},
    {"5", {1.275          , 0.225              ,  180.0}}
};

class WaitStartBTNode : public BT::ActionNodeBase
{
    public:
        explicit WaitStartBTNode(
